...
class SupplyVoltageMilliVolts : Sensor<uint16_t>
  {
  private:
  ...
  public:
    ...
    virtual uint16_t get() { return(mV); }
    ...
    virtual bool isValid(const uint16_t value) { return(true); }
    ...
    bool isSupplyVoltageLow() { return(isLow); }
  };
