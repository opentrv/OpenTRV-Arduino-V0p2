...
#ifdef CONFIG_Trial2013Winter_Round1 // For trial over winter of 2013, first round, NOT hub.
// Revision of V0.2 board.
#define V0p2_REV 1
// Use common settings.
#define COMMON_SETTINGS
...
#ifdef COMMON_SETTINGS
#if (V0p2_REV >= 1) && (V0p2_REV <= 2) // All REV 1--2 PCBs use RFM23.
