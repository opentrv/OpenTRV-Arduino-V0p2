...
// Should be greater than the gap between transmissions (eg ~2m for FHT8V/FS20).
// Valves may have to linger open at minimum this plus maybe an extra minute or so for timing skew
