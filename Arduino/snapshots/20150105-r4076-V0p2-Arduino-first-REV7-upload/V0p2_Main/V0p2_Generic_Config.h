...
// IF DEFINED: this unit will act as a thermostat controlling a local TRV (and calling for heat from the boiler), else is a sensor unit.
#define LOCAL_TRV
...
#if (V0p2_REV >= 1) && (V0p2_REV <= 7) // && !defined(CONFIG_DHD_TESTLAB_REV2) // All REV 1--7 PCBs use RFM23B.
