...
void serialPrintlnBuildVersion()
  ...
  serialPrintAndFlush(F("; code $Id: V0p2_Main.ino 3793 2014-12-06 19:10:40Z damonhd $ ")); // Expect SVN to substitute the Id keyword here with svn:keywords property set.
