...
//#define CONFIG_DHD_TESTLAB_REV0 // REV0
...
// Wake at 2Hz for accurate 0.5-second timing for some possible extra power draw.
//#define HALF_SECOND_RTC_SUPPORT
...
#define V0p2_REV 0 // REV0 covers DHD's breadboard and first V0.2 PCB.
...
#if (V0p2_REV >= 1) && (V0p2_REV <= 4) // && !defined(CONFIG_DHD_TESTLAB_REV2) // All REV 1--4 PCBs use RFM23B.
...
// IF DEFINED: support temperature TX, eg traling stats message after FHT8V payload.
#define SUPPORT_TEMP_TX
// IF DEFINED: this unit can act as boiler-control hub listening to remote thermostats, possibly in addition to controlling a local TRV.
//#define ENABLE_BOILER_HUB // NOT defined by default to allow omission for pure leaf nodes.
// IF DEFINED: allow send and receive of minimal binary stats frame, eg as an optimisation.  @20141205 ~400 bytes of code.
