...
static const uint8_t OCCCP_SHIFT =
  ((OCCUPATION_TIMEOUT_M <= 3) ? 5 :
  ((OCCUPATION_TIMEOUT_M <= 6) ? 4 :
  ((OCCUPATION_TIMEOUT_M <= 12) ? 3 :
  ((OCCUPATION_TIMEOUT_M <= 25) ? 2 :
  ((OCCUPATION_TIMEOUT_M <= 50) ? 1 :
  ((OCCUPATION_TIMEOUT_M <= 100) ? 0 :
  ((OCCUPATION_TIMEOUT_M <= 200) ? -1 : -2)))))));
