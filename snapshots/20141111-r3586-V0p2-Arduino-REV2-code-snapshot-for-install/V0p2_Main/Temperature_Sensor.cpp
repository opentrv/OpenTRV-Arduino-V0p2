...
/*
 ...
 Default implementation is TMP112/TMP102 with ADD0 tied to Gnd.

 For SHT21 see more info and examples here:
 http://www.sensirion.com/sht21
 http://playground.arduino.cc/code/Sensirion
 https://github.com/misenso/SHT2x-Arduino-Library
 
 Note that the SHT20 is a lower-cost version or the SHT21, and the SHT25 is higher-accuracy, eg:
