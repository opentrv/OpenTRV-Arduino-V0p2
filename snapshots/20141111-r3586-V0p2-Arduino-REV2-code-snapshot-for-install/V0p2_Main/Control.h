...
#define isLikelyRecentlyOccupied() (false) // Always false without OCCUPANCY_SUPPORT
...
#define twoBitOccValue() (0) // Always 0 without OCCPANCY_SUPPORT.
