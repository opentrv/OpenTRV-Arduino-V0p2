...
#define OUT_HEATCALL 6  // ATMega328P-PU PDIP pin 12, PD6, o usable analogue input.
...
// IF DEFINED: reverse direction of REV2/3/4 temperature put usage.
...
// SHT21 sensor used on REV4 R&D board.
#if V0p2_REV == 4
...
static inline void IOSetup()
  ...
  for(int i = 14; --i >= 0; ) // For all digital pins from 0 to 13 inclusive...
    ...
    switch(i)
      ...
      // Make button pins inputs with internal weak pull-ups (saving an external resistor in each case).
