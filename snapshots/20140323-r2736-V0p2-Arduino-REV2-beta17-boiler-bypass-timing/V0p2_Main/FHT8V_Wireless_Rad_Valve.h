...
// IF DEFINED: use RFM22 RX sync to indicate call for heat from boiler rather than reading the FHT8V frame content.
...
#define FHT8VRXErr_NONE 0
#define FHT8VRXErr_GENERIC 1
#define FHT8VRXErr_BAD_PREAMBLE 2
#define FHT8VRXErr_BAD_RX_FRAME 3
