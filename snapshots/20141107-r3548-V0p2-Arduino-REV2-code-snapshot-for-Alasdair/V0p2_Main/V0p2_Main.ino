...
void serialPrintlnBuildVersion()
  ...
  serialPrintAndFlush(F("; code $Id: V0p2_Main.ino 3548 2014-11-07 12:04:42Z damonhd $ ")); // Expect SVN to substitute the Id keyword here with svn:keywords property set.
