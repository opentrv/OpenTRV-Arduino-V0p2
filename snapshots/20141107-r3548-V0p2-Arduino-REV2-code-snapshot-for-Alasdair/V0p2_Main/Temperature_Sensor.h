...
// IF SHT21 support is enabled at compile-time then sensor may be used at run-time.
...
// In case of error this will return a zero or negative value, which should be fail-safe.
...
#ifdef SENSOR_SHT21_ENABLE
// This sensor provides relative humidity readings and temperature.
#endif
