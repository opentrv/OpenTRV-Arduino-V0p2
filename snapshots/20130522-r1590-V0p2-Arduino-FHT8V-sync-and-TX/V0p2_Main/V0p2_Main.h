...
//#define UNIT_TESTS // If defined, normal main loop is REPLACED with a unit test cycle.  Usually define DEBUG also for serial logging.

#define WAKEUP_32768HZ_XTAL // Use sleep wakeup (1Hz by default) from external 32768Hz xtal and timer 2.
...
#ifndef BAUD
#define BAUD 4800 // Ensure that our 'standard' UART speed is set unless explicitly overridden.
#endif
...
// Only really intended for ATmega368P.
#ifdef __AVR_ATmega328P__
// READ GENERIC
/* Register: PIND for 0--7, PINB for 8--13, PINC otherwise. */
...
// WRITE GENERIC
/* Register: PORTD for 0--7, PORTB for 8--13, PORTC otherwise (eg 13 is PORTB). */
/* Bit: 0--7 as-is, 8--13 subtract 8, else subtract 14. */
// Handle quickly constant-value pins that we know about; fall back to generic run-time routine for rest.
